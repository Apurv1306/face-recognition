...
# (str) URL for the buildozer distribution service (leave default unless you know what you're doing)
# android.dist_url = https://github.com/kivy/kivy-sdk-buildozer/releases/download/v0.1

# (bool) Whether to remove all other architectures except the one specified (for smaller APK size)
# android.single_architecture = False
